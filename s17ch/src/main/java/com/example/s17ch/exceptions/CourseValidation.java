...
public class CourseValidation {
    ...
    private static final String COURSE_IS_ALREADY_EXIST = "Course with given id is already exist";
    ...
    public static void isCourseExist(List<Course> courses, int id, boolean boo){
        if(boo){
            ...
            for(Course course : courses){
                if(!(course.getCourseId() == id)){
                    throw new CourseException(COURSE_IS_ALREADY_EXIST + id, HttpStatus.BAD_REQUEST);
                }
            }
        }
